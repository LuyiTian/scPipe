...
```{r}
trimbarcode_stats_filename    <- file.path("/stornext/Home/data/allstaff/y/yang.p/repos/final_repos/scPipe/scPipe-atac-output", "scPipe_atac_stats", "stats_file_trimbarcode.txt")
