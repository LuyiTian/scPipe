...
test_that("Correct input positions are accepted", {
    ...
    expect_true(check_barcode_start_position(small_r1, small_barcode, 0, 4, 40, .5))
})
...
test_that("Bad input position causes rejection", {
    ...
    expect_false(check_barcode_start_position(small_r1, small_barcode, 10, 4, 40, .5))
})
...
test_that("Bad match rate causes rejection", {
    ...
    expect_false(check_barcode_start_position(small_r1, small_barcode, 0, 4, 100, .5))
})
