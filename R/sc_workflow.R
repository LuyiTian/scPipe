...
#'
#' after we run \code{sc_gene_counting} and finish the preprocessing step. \code{createSCDByDir}
...
#'
#' @details after we run \code{sc_gene_counting} and finish the preprocessing step. \code{createSCDByDir}
#' can be used to generate the SCData obeject from the folder that contains gene counting matrix and QC statistics.
#'
...
createSCDByDir <- function(datadir, organism=NULL, gene_id_type=NULL, pheno_data=NULL) {
...
#' @export
#'
createReport <- function(sample_name,
                         outdir,
                         r1,
                         r2=NULL,
                         outfq,
...
runscPipe <- function(sample_name,
  ...
  scd = createSCDByDir(datadir=outdir, organism=organism, gene_id_type=gene_id_type)

  createReport(sample_name=sample_name,
                outdir=outdir,
                r1=r1,
                r2=r2,
                outfq=out_fq,
