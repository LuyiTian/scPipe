...
check_barcode_reads <- function(fastq, barcodeseqs, barcodeStart, barcodeLength) {
    invisible(.Call(`_scPipe_check_barcode_reads`, fastq, barcodeseqs, barcodeStart, barcodeLength))
}
