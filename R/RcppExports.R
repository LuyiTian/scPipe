...
testing_resize_array <- function(size, values) {
    invisible(.Call(`_scPipe_testing_resize_array`, size, values))
}

check_barcode_reads <- function(fastq, barcodeseqs, barcode_start, barcode_length, lines_to_search) {
    .Call(`_scPipe_check_barcode_reads`, fastq, barcodeseqs, barcode_start, barcode_length, lines_to_search)
}
