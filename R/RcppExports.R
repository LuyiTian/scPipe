...
check_barcode_reads <- function(fastq, barcodeseqs, barcode_start, barcode_length) {
    invisible(.Call(`_scPipe_check_barcode_reads`, fastq, barcodeseqs, barcode_start, barcode_length))
}
