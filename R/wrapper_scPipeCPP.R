...
#' The result will be written into optional fields in bam file with different tags. 
#' following this link for more information regarding to bam file format:
...
#' sc_demultiplex
#' 
#' @description This function will process bam file by cell barcode, output to outdir/count/[cell_id].csv.
...
#' @param min_count minimum counts to keep, barcode will be discarded if it has lower count.
#' Default value is 10. This should be set according to \code{max_reads}.
#' @param max_mismatch the maximum mismatch allowed. Barcodes within this number will be 
#' considered as sequence error and merged, default to be 1.
#' @export
#' @return no return
#' @examples
#' \dontrun{
