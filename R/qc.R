...
#' @param comp the number of component used in GMM. Depending on the quality of the experiment.
#' @param sel_col a vector of column names which indicate the columns to use for QC.
...
plot_demultiplex = function(sce){
  ...
  p = ggplot(data=demultiplex_stat, aes(x="", y=demultiplex_stat[,"count"], fill=demultiplex_stat[,"status"]))+
