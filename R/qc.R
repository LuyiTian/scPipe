...
#' @importFrom ggplot2 ggplot geom_bar aes_string xlab ylab theme element_blank scale_fill_brewer ggtitle scale_y_continuous
#' @return a ggplot2 object
#' @export
#'
#' @examples
...
#' @importFrom ggplot2 theme_minimal theme element_text element_blank ggplot aes geom_bar scale_fill_brewer geom_text labs
#' @export
#'
#' @examples
#' data("sc_sample_data")
...
#' @importFrom ggplot2 ggplot geom_smooth aes theme_bw labs scale_x_log10
#' @export
#'
#' @examples
#' data("sc_sample_data")
